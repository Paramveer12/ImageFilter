...
Java_com_example_imageeditor_FilterActivity_Jnimedian(JNIEnv *env, jobject ZObject,jobject bitmap ){
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_imageeditor_FilterActivity_Jnimean(JNIEnv *env, jobject ZObject,jobject bitmap ){
AndroidBitmapInfo  info;
int ret;
void* pixels;
